                ...
                <a href="javascript:;" class="operation" >
                  <el-dropdown @visible-change="toDown" style='position: initial;'>
                    ...
                    <el-dropdown-menu slot="dropdown">
                      ...
                      <router-link  target="_blank" :to="{path:'/singlegroup',query: {id: list.id}}" style='color: #3ec3c8;' class="hasid" id="7db5db31735d11e788410242ac120009" >导出行程</router-link>
                      </el-button>
                      </el-dropdown-item>
                      <el-dropdown-item >
                      ...
                      <el-dropdown-item>
                        <el-button type="text" class="hasid" id="83b7ed61735d11e788410242ac120009">
                          ...
                          <router-link  target="_blank" :to="{path:'/exportgroup',query: {id: list.id}}" style='color: #3ec3c8;' class="hasid" id="83b7ed61735d11e788410242ac120009">导出出团单</router-link>
                        </el-button>
                      </el-dropdown-item>
                    </el-dropdown-menu>
                  </el-dropdown>
