								...
								<el-col :span="4">
									<el-form-item prop="trafficgo">
										<el-select v-model="baseForm.trafficgo" placeholder="请选择">
											<el-option v-for="item in traffics" :key="item.label" :label="item.label" :value="item.value">
											</el-option>
										</el-select>
									</el-form-item>
								</el-col>
...
<script>
	...
	import {country,  linesave, province, city, district, categoryall, linecategorytype, lineupdate, linedetail,token } from '../../../common/js/config';
