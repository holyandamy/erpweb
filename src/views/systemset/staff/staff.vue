...
<header>
	<el-row>
		...
		<el-table :data="stafflist" style="text-align: left; font-size: 12px;">
			<el-table-column prop="bankName" label="序号">
			</el-table-column>
			<el-table-column prop="name" label="用户名">
			</el-table-column>
			<el-table-column prop="account" label="真实姓名">
			</el-table-column>
			<el-table-column prop="status" label="性别" >
			</el-table-column>
			<el-table-column prop="account" label="电话号码">
			</el-table-column>
	...
	components:{
		...
		methods:{
			...
			getlist(){
		    	...
		    	axios.post("https://172.17.9.13:3001/api/sys/user/list",page).then((res) => {
